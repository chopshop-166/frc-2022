...
public class GastonMap extends RobotMap {
    ...
    // private final PIDSparkMax leftMotor = new PIDSparkMax(0,
    // MotorType.kBrushless);
    // private final PIDSparkMax rightMotor = new PIDSparkMax(1,
    // MotorType.kBrushless);
    ...
    // private final PIDSparkMax deploymentMotor = new PIDSparkMax(2,
    // MotorType.kBrushless);
    // private final PIDSparkMax rollerMotor = new PIDSparkMax(3,
    // MotorType.kBrushless);
    // private final SparkMaxPIDController deploymentPidController =
    // deploymentMotor.getPidController();

    // public IntakeMap getIntakeMap() {
    // // PID coefficients
    // // initializes relative encoder and pid controller, we don't need the encoder
    // rn
    ...
    // return new IntakeMap(rollerMotor, deploymentMotor, outsideLimit::get,
    // insideLimit::get);
    ...
    // return new TelescopeMap(rightMotor, rightUpperLimit::get,
    // rightLowerLimit::get);
    // }
}
